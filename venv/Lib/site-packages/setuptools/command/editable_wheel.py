          ...
          in the project directory...)
            {
              ...
              "tasks": [
                ...
                // Project 4 Tasks
                {
                  "taskLabel": "project4-start",
                  "appliesTo": "/",
                  "type": "launch",
                  "command": "npm",
                  "args": ["start"],
                  "options": {
                    "cwd": "${workspaceFolder}/project4"
                  },
                  "problemMatcher": "$tsc"
                },
                {
                  "taskLabel": "project4-build",
                  "appliesTo": "/",
                  "type": "build",
                  "command": "npm",
                  "args": ["run", "build"],
                ...
                // Project 5 Tasks
                {
                  "taskLabel": "project5-build",
                  "appliesTo": "/",
                  "type": "build",
                  "command": "gcc",
                  "args": ["-o", "output", "main.c"],
                  "options": {
                    "cwd": "${workspaceFolder}/project5"
                  },
                  "problemMatcher": "$gcc"
                },
                ...
                // Project 7 Tasks
                {
                  "taskLabel": "project7-build",
                  "appliesTo": "/",
                  "type": "build",
                  "command": "customCommand",
                  "args": ["arg1", "arg2"],
                  "options": {
                    "cwd": "${workspaceFolder}/project7"
                  },
